...
# 训练过程的参数
parser.add_argument("--net_name", type=str, default="Unet", help="选择模型结构:[Unet,Nested_UNet]")
...
parser.add_argument("--scheduler", type=str, default="StepLR", help="学习率衰减方式:[StepLR,MultiStepLR,ExponentialLR]")
